...
class Alumnos(models.Model):
    ...
    carrera_fk = models.ForeignKey(Carreras, null=True, on_delete=models.CASCADE)
    titulo_fk = models.ForeignKey(Titulados, null=True, on_delete=models.CASCADE)
    certificado_fk = models.ForeignKey(Certificados, null=True, on_delete=models.CASCADE)
